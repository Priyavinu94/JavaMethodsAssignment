...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// the resultant of operations performed gets stored at index 0 next.. and so
		// on..
		...
		// check if the operator is valid and stores the boolean value. if true, enters
		// loop and gets second input
		...
		Loop: while (isValidOperator) { // Statement labelled in order to exit the loop from switch case when needed.
